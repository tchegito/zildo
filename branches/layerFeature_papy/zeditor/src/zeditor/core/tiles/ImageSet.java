...
public abstract class ImageSet extends JPanel {
	...
	/**
	 * Méthode privée de tri des Points de sélection. Le point en haut à gauche
	 * devient le point de départ et le point en bas à droite devient le point
	 * de fin.
	 */
	...
	public void paint(Graphics g) {
		...
		// On dessine un cadre autour des tuiles sélectionnées en dernier pour
	 ...
	 * @param outer
	 *            : Couleur de l'extérieur de cadre
	 * @param inner
	 *            : Couleur de l'intérieur de cadre
	 * @param p_startPoint
	 *            : Point de départ du cadre
	 * @param p_stopPoint
