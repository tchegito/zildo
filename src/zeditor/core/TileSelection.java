 ...
 * <p>
 * 	<ul>
 * 		<li>La liste des éléments sélectionnés héritée de la classe {@link Selection}</li>
 * 		<li>La largeur de la sélection en nombre de cases</li>
 * 		<li>La hauteur de la sélection en nombre de cases</li>
 * 	</ul>
 * </p>
 * <p>
 * Un élément de la liste représente l'id de la tuile. La liste <u>doit</u> être remplie de cette manière :
 * </p>
 * <b>TileSet</b>
 * <table border="solid">
 * 	<tr><td></td><td>X</td><td>X+1</td><td>X+2</td></tr>
 * 	<tr><td>Y</td><td>A</td><td>B</td><td>C</td></tr>
 * 	<tr><td>Y+1</td><td>D</td><td>E</td><td>F</td></tr>
 * 	<tr><td>Y+2</td><td>G</td><td>H</td><td>I</td></tr>
 * </table>
 * <p> <b>liste</b><br />
 * 	{A,B,C,D,E,F,G,H,I}
 * </p>
...
public class TileSelection extends Selection {
	...
	/**
	 * Constructeur
	 * @param w est la largeur de la sélection (en nombre de cases)
	 ...
	 * @param width est la nouvelle largeur à assigner (en nombre de cases)
	 */
	 ...
	 * @param height est la nouvelle hauteur à assigner (en nombre de cases)
	 */
