...
public class GUIManagement {
	...
	public GUIManagement()
	{
		...
		filterCommand=EngineZildo.filterCommand;
	...
	*/
				...
				for (int k=0;k< (i-j) && it.hasNext();k++) {
					...
					if (entity.getScrY() < Constantes.TEXTER_COORDINATE_Y) {
						...
						if (i==sentence.length()) {
							...
							EngineZildo.soundManagement.playSoundFX("AfficheTexteFin");
						}
					} else {
	...
	///////////////////////////////////////////////////////////////////////////////////////
	void drawGeneralGUI() {
		PersoManagement persoManagement = EngineZildo.persoManagement;
