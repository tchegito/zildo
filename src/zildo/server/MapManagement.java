...
public class MapManagement {
	 ...
	 * @return Area
	 */
	public Area deserializeMap(EasyBuffering p_buffer, boolean p_spawn) {
	...
	{ 
		...
		Area map=deserializeMap(file, true);
	...
	public void saveMapFile(String p_fileName) {
		EasyWritingFile serializedMap = new EasyWritingFile(serializeMap());
