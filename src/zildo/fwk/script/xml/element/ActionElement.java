...
public class ActionElement extends AnyElement {
	...
	public enum ActionKind {
		actions, pos, moveTo, speak, script, angle, wait, sound, clear, fadeIn, fadeOut, map, focus, spawn, exec, take, mapReplace, music, animation, impact, remove, markQuest, putDown;
