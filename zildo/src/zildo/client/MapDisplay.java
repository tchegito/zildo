...
public class MapDisplay {
	...
	private Point targetCamera; // Target camera location (if not null, camera
								// moves smoothly to it)
	...
	private ForeBackController foreBackController = new ForeBackController();
	...
	public void centerCamera() {
		...
		if (scrollingAngle == null) {
			...
			if (camera.y > (16 * currentMap.getDim_y() - (CENTER_Y << 1))) { // marche
																				// avec
																				// 17
	...
	public ForeBackController getForeBackController() {
		return foreBackController;
	}
