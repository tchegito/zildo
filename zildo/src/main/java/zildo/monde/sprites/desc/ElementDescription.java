...
public enum ElementDescription implements SpriteDescription {
	...
	// 123
	KEY, SCROLL, BIG_HEART, HEART_FRAGMENT, HAMMER, CRYSTAL, LANTERN, FIRE_STAFF, ICE_STAFF, EXCALIBUR, BOOK, NECKLACE_RED, GLOVE, NECKLACE_GREEN, NECKLACE_BLUE, TINY_VIAL, VIAL, GRAPNEL, SUPER_GLOVE, FLIPPER, BOOTS, CUP, PURSE, FLASK, FLASK_RED, FLASK_YELLOW, FLASK_BLUE,
	// 150
