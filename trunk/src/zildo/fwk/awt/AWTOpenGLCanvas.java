 ...
 * com.evildevil.bubble.core Copyright (c) 2004 - 2005 Benjamin "Evil-Devil" Behrendt All rights reserved
 * --------------------------------------------------------------------------
 */
...
public class AWTOpenGLCanvas extends AWTGLCanvas implements Runnable {
	...
	public void paintGL() {
		...
		try {
			...
			if (cursorLocation != null) {
				...
				ortho.boxv(cursorLocation.x, cursorLocation.y, size.x, size.y, 0, new Vector4f(1, 1, 1, 1));
			}
	...
	/**
	 * If the context is created and a IRenderable object is provided, then IRenderable.initRenderer() will be called to setup the states
	 * etc that were used.
