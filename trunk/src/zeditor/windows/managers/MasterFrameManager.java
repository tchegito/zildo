...
public class MasterFrameManager {
	...
	/**
	 * Sauve la carte en cours dans la carte en cours. Si la carte en cours n'a pas encore été sauvegardée, on appelle la méthode
	...
	/**
	 * Met à jours les boutons de la ToolBar. Cette méthode est dépendante de la structure de la fenêtre. MasterPanel >> ToolbarContainer >>
	 * ToolBar
	 * @author Drakulo
	 */
