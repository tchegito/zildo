...
public class TileSet extends JPanel {
	...
	/**
	 * Méthode de chargement dynamique des tiles présents dans le dossier défini des Tiles.
	...
	public static Object[] getTiles() throws ZeditorException {
		...
		if (list.isEmpty()) {
			throw new TileSetException("Le dossier paramétré ne contient aucun tileSet");
		}
		return list.toArray();
	}
	...
	/**
	 * Méthode privée de tri des Points de sélection. Le point en haut à gauche devient le point de départ et le point en bas à droite
	 * devient le point de fin.
	 */
